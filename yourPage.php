...
<body>
		...
		<form action='/save_user.php' method='POST' enctype='multipart/form-data'>
			...
			<div class='user_imgs'>
				...
				<?php
					...
					echo '<div class=\'line\'>
					<input name=\'file\' type=\'file\' id=\'input__file\' class=\'input input__file\' accept=\'image/*\'>
			...
			<div class='user_posts'>
				...
				<?php
					if ($_SESSION['logged_user']->howManyPostsHasUser == 0) {
						echo "<div class='info'>У вас нет постов!</div>";
					}else{
						echo "<div class='all_posts'>";
						for ($i = 0; $i < $_SESSION['logged_user']->howManyPostsHasUser; $i++) {
							$post = $_SESSION['logged_user']->allPosts[$i];
							$path = $post['path'];
							$name = $post['name'];
							echo '
								<div class="post_view">
									<div class="post_wrapper">
										...
										<div class="post_info">
											...
											<div class="else_info">
												...
												<div class="author">
													Автор: 
													<a href="/profile.php?id='.$_SESSION['logged_user']->id.'">'.$_SESSION['logged_user']->login.'</a>
												</div>
												<div class="flex_line">
					...
					echo "Вы можете добавить посты:";
					echo '<div class=\'line\'>
						<a href=\'\\constructor\\constructor.php\' style=\'text-decoration: none;\'>
							<div class=\'save\'>Добавить</div>
						</a>
					</div>';
				?>
			</div>
	...
	<!-- Отображаем активную фотографию -->
